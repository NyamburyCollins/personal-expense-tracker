...
transactions = [
    ...
    Transaction(description="Bundles", amount=-1200, category="Food", date=datetime.date(2024, 5, 4)),
    Transaction(description="Transport to town", amount=-3000, category="Transport", date=datetime.date(2024, 5, 5)),
    Transaction(description="Bought a book", amount=-700, category="Shopping", date=datetime.date(2024, 5, 6)),
    Transaction(description="Allowance from Work", amount=3000, category="Income", date=datetime.date(2024, 5, 7)),

    Transaction(description="January Rent", amount=-10000, category="Rent", date=datetime.date(2025, 1, 5)),
    Transaction(description="Weekly Food", amount=-3200, category="Food", date=datetime.date(2025, 1, 6)),
